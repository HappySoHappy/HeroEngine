...
namespace HeroEngine.Desktop.Material
{
    ...
    public partial class BorderTextBox : UserControl
    {
        ...
        //since i dont know how to fix it just leave it as is
        ...
        {
            private readonly BorderTextBox _textBox;

            public MessageFilter(BorderTextBox textBox)
            {
                _textBox = textBox;
            }
            ...
            {
                // Handle mouse clicks (WM_LBUTTONDOWN) outside the textbox
                if (m.Msg == 0x201) // WM_LBUTTONDOWN message
                {
                    Point mousePos = Control.MousePosition;
                    if (!_textBox.ClientRectangle.Contains(_textBox.PointToClient(mousePos)))
                    {
