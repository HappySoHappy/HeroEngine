...
{
    public class ClaimGuildBattleReward : Request
    {
        public int Id;
        public bool Discard;
        public ClaimGuildBattleReward(Account account, int id, bool discard = false) : base(account, "claimGuildBattleReward")
        {
            Id = id;
        }
